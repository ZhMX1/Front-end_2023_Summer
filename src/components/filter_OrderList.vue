...
<!--            </div>-->
          ...
          <div class="order-left-list-appointment-date-box">
            ...
            <div class="order-left-list-appointment-date">
              任务时间:  {{item.assign_time.substring(0,4)}}年{{ item.assign_time.substring(5,7)}}月{{ item.assign_time.substring(8,10)}}日
              &nbsp; {{ item.assign_time_stage}}
            </div>
          </div>
